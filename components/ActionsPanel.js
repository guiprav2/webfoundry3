...
class ActionsPanel {
  ...
  render = () => d.html`
    <div class="ActionsPanel flex flex-col bg-[#091017] text-neutral-100 w-96 h-screen border-r border-black/50 p-6 space-y-4 select-none overflow-auto">
      ...
      <div>Deploy</div>
      <button class="text-left px-4 py-2 rounded-md bg-black/50 hover:bg-black/70 flex justify-between gap-3 outline-none w-full" ${{ onClick: () => post('app.editorAction', 'D') }}>
